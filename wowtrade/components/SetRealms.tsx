...
export function SetRegionRealmView() {
    ...
    return <Row>
        <Col>
            ...
            <Form.Control className={"bg-dark text-white"} as="select" value={context.region} onChange={(e) => {
        ...
        <Col>
            ...
            <Form.Control className={"bg-dark text-white"} as="select" value={context.realm} onChange={(e) => {
